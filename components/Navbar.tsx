      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          <div className="flex items-center">
            ...
            >
              {/* Logo Container with fixed aspect ratio to prevent layout shift */}
              ...
              <div className="flex flex-col">
                <span className={`font-extrabold text-lg sm:text-xl tracking-tight transition-colors duration-500 leading-none ${isScrolled ? 'text-brand-slate' : 'text-white'}`}>
                  Ingenium
                </span>
                <span className={`text-[8px] sm:text-[10px] font-bold tracking-[0.2em] uppercase transition-colors duration-500 mt-1 ${isScrolled ? 'text-brand' : 'text-brand-light'}`}>
                  Virtual Assistant
                </span>
              </div>
            </a>
