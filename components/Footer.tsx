          ...
          <div className="col-span-1 sm:col-span-2 md:col-span-1">
            <div className="flex items-center gap-3 mb-6 sm:mb-8">
              ...
              <div className="flex flex-col">
                <span className="font-black text-xl sm:text-2xl tracking-tight leading-none">Ingenium</span>
                <span className="text-[9px] sm:text-[11px] font-bold tracking-[0.2em] uppercase text-brand mt-1">Virtual Assistant</span>
              </div>
            </div>
